from flask import Flask, flash, render_template, request, redirect, jsonify, url_for, abort
app = Flask(__name__)
...
if __name__ == '__main__':
	app.secret_key = "%\xe5\xe4'\xaf\x15\xeac\xe2\x0ce\xca\x08rd\x12\x12\xdf\xdc\xe0\xad\xb4\xf9\xf0"
	app.debug = True
